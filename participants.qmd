...
:::
::: {.column width="50%"}
Michaël Bourdon is a graduate student at ENS.
:::
:::
<!-- end one person -->
...
::: columns
::: {.column width="30%"}
![](https://wsrv.nl/?url=https://raw.githubusercontent.com/jmigozzi/masterclass/master/assets/elisa.png&w=200&h=200&fit=cover&mask=circle&maxage=7d)
:::
::: {.column width="10%"}
:::
::: {.column width="50%"}
Elisa Crestani Befve is a graduate student at the department of Social Sciences (ENS). Her master thesis focuses on the role of the Muslim community of the Nyamirambo sector (Kigali) during the Tutsi genocide in Rwanda. Her interest in urban studies encouraged her to conduct two short inquiries during an internship at IFRA Nairobi, on the Yemeni refugee community in Eastleigh, and with women seeking to be employed in Kileleshwa
:::
:::
<!-- end one person -->
...
:::
::: {.column width="50%"}
Charlotte Monluc is a graduate student at ENS.
:::
:::
<!-- end one person -->
...
:::
::: {.column width="50%"}
Laetitia Ouedraogo is a graduate student at ENS.
:::
:::
<!-- end one person -->
