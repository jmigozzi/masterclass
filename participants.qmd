...
::: columns
::: {.column width="30%"}
![](https://wsrv.nl/?url=https://raw.githubusercontent.com/jmigozzi/masterclass/master/assets/siya.JPG&w=200&h=200&fit=cover&mask=circle&maxage=7d)
:::
::: {.column width="10%"}
:::
::: {.column width="50%"}
Siya Ntuntwana has an undergraduate degree in Architecture and an honours degree in Landscape Architecture. He is currently pursuing a Master's in Urban Design. His research aims to reverse the migration of residents in peripheral cities by developing infrastructure and public spaces that align with their context with the aim to improve service delivery, quality of life, and economic opportunities. Siya is passionate about integrating design with social justice advocacy and activism to create dignified spaces.   
:::
:::
<!-- end one person -->
...
::: columns
::: {.column width="30%"}
![](https://wsrv.nl/?url=https://raw.githubusercontent.com/jmigozzi/masterclass/master/assets/laeticia.jpgg&w=200&h=200&fit=cover&mask=circle&maxage=7d)
:::
::: {.column width="10%"}
:::
::: {.column width="50%"}
